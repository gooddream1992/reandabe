...
class NewComproController extends Controller{
  ...
  public function career(){
    ...
    return view('pages.compro.career')->with('servs', $serv)->with('produk', $produk)->with('setting', $setting)->with('tata', $tata)->with('footerTrain', $footerTrain)->with('menuTop', $menuTop)->with('menuMiddle', $menuMiddle)->with('footer', $footer)->with('title', $title)->with('imgTop', $imgTop)->with('allProduk',$allProduk);
  ...
  */
  ...
  public function serviceListId($id){
    ...
    return view('pages.compro.servicesListId')->with('servs', $serv)->with('count', $count)->with('contact1', $contact1)->with('contact', $contact)->with('subService', $subService)->with('service', $service)->with('setting', $setting)->with('footer', $footer)->with('title', $title);
  ...
  public function serviceSub($id){
    ...
    return view('pages.compro.subService')->with('servs', $serv)->with('partner', $partner)->with('contact_two', $contact_two)->with('contact_one', $contact_one)->with('subService', $subService)->with('setting', $setting)->with('footer', $footer)->with('title', $title);
