...
class AdminServicesController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->get('image-data')){
            ...
            DB::table('cms_servicelist')->insert([
                'name'            => $request->nama,
    ...
    public function edit($id){
        ...
        ->where('id', 1)
        ->first();  
        return view('pages.cms_compro.service.service.edit')->with('contacts', $contacts)->with('post', $post)->with('setting', $setting);
    }
