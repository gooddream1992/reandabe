...
class AdminSubServicesController extends Controller
{
    ...
    public function store(Request $request, $sid){
        ...
        if($request->get('image-data')){
            ...
            DB::table('cms_sub_services')->insert([
                'service_id'      => $sid,
                'name'            => $request->nama,
            ...
            DB::table('cms_sub_services')->insert([
                ...
                'description'     => $request->description_ch,
                'situation_part'  => $request->situasi,
    ...
    public function edit($sid, $id){
        ...
        ->where('id', 1)
        ->first();  
        return view('pages.cms_compro.service.subService.edit')->with('contacts', $contacts)->with('post', $post)->with('setting', $setting);
    }
