                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <select name="enquiry" id="" class="form-control" required>
                                        ...
                                        <option value="Assurance Services">@lang('main.enquiry_detail2')</option>
                                        <option value="Advisory Services">@lang('main.enquiry_detail3')</option>
                                        <option value="Tax Services">@lang('main.enquiry_detail4')</option>
                                        <option value="M & A Services">@lang('main.enquiry_detail5')</option>
                                        <option value="Press & Media">@lang('main.enquiry_detail6')</option>
                                        <option value="Publications & Marketing Materials">@lang('main.enquiry_detail7')</option>
                                        <option value="Submit Request for Proposal">@lang('main.enquiry_detail8')</option>
                                    </select>
                                </div>
                            </div>
                            <br>
